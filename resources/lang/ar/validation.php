...
return [
    ...
    'custom' => [
        'driver_name' => [
            'required' => 'يرجى إدخال اسم السائق.',
            'string' => 'يجب أن يكون اسم السائق نصاً.',
            'max' => 'اسم السائق لا يجب أن يتجاوز :max حرفاً.',
        ],
        'driver_phone' => [
            'required' => 'يرجى إدخال رقم هاتف السائق.',
            'string' => 'يجب أن يكون رقم الهاتف نصاً.',
            'min' => 'رقم الهاتف قصير جداً، يرجى التأكد من الرقم.',
            'max' => 'رقم الهاتف لا يجب أن يتجاوز :max حرفاً.',
        ],
        'selected_ids' => [
            'required' => 'يرجى اختيار طرد واحد على الأقل.',
            'array' => 'بيانات الطرود المختارة غير صحيحة.',
            'min' => 'يجب اختيار طرد واحد على الأقل للشحن.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'receiver_customer_id' => 'العميل المستلم',
        'sender_name' => 'اسم المرسل',
        'sender_phone' => 'هاتف المرسل',
        'receiver_name' => 'اسم المستلم',
        'receiver_phone' => 'هاتف المستلم',
        'sender_branch_code' => 'فرع الإرسال',
        'receiver_branch_code' => 'فرع الاستقبال',
        'package_type' => 'نوع الطرد',
        'weight' => 'الوزن',
        'total_amount' => 'المبلغ الإجمالي',
        'code' => 'الرمز',
        'no_honey_jars' => 'عدد قروف العسل',
        'no_gallons_honey' => 'عدد جوالين العسل',
        'payment_method' => 'طريقة الدفع',
        'prepaid_payment_method' => 'طريقة الدفع المقدم',
        'prepaid_attachment' => 'سند التحويل',
        'partial_amount' => 'المبلغ المدفوع جزئياً',
        'customer_debt_status' => 'حالة مديونية العميل',
        'notes' => 'الملاحظات',
        'driver_name' => 'اسم السائق',
        'driver_phone' => 'هاتف السائق',
        'selected_ids' => 'الطرود المختارة',
    ],
];