...
<div x-data="{ 
    ...
    {{-- الهيدر العلوي --}}
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-4 mt-6 bg-white rounded-2xl border border-gray-100 shadow-sm dark:bg-boxdark dark:border-boxdark-2 lg:p-6 gap-4">
        <div class="flex gap-4 items-center">
            <a href="{{ route('shipmentpackage.incoming.index') }}" 
                class="flex justify-center items-center w-12 h-12 bg-gray-50 rounded-2xl border border-gray-100 text-gray-400 hover:bg-primary hover:text-white transition-all dark:bg-boxdark-2 dark:border-boxdark-2 shadow-sm active:scale-95">
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <span class="text-xs font-bold text-gray-400 px-2 py-1 rounded-lg border border-gray-50 dark:border-boxdark">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="p-6 bg-white rounded-[2rem] border border-gray-100 shadow-sm dark:bg-boxdark dark:border-boxdark-2">
                <h3 class="text-sm font-black text-on-surface dark:text-white mb-6 flex items-center gap-2">
                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-2xl bg-blue-50 text-blue-500 flex items-center justify-center dark:bg-boxdark-2">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-2xl bg-emerald-50 text-emerald-500 flex items-center justify-center dark:bg-boxdark-2">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                @if($package->driver && $package->driver->phone)
                                    <div class="flex gap-1">
                                        <a href="tel:{{ $package->driver->phone }}" class="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400 hover:text-primary transition-colors">
                                            <span class="material-symbols-outlined text-[18px]">call</span>
                                        </a>
                                        <a href="https://wa.me/{{ preg_replace('/\D/', '', $package->driver->phone) }}" target="_blank" class="w-8 h-8 rounded-lg bg-emerald-50 flex items-center justify-center text-emerald-500 transition-colors">
                    ...
                    @if($package->notes)
                    <div class="p-4 rounded-2xl bg-gray-50 dark:bg-boxdark-2 border border-gray-100 dark:border-boxdark mt-6">
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">ملاحظات إضافية</p>
                        <p class="text-xs font-bold text-gray-600 dark:text-bodydark leading-relaxed">
                            {{ $package->notes }}
                        </p>
                    </div>
                    @endif
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="p-6 bg-boxdark rounded-[2rem] text-white shadow-lg shadow-boxdark/20 relative overflow-hidden group">
                    <div class="absolute -right-4 -bottom-4 w-16 h-16 bg-white/5 rounded-full blur-xl group-hover:scale-110 transition-transform"></div>
                ...
                @foreach($package->shipments as $shipment)
                    <div class="flex flex-col p-5 bg-white rounded-[2rem] border border-gray-100 shadow-sm transition-all hover:shadow-md dark:bg-boxdark dark:border-boxdark-2 relative overflow-hidden group">
                        @if($shipment->status == 'delivered')
                            <div class="absolute -left-6 -top-6 w-12 h-12 bg-emerald-500/10 rotate-45 flex items-end justify-center pb-1">
                        ...
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h4 class="font-mono text-sm font-black text-on-surface dark:text-white mb-1">#{{ $shipment->code }}</h4>
                        ...
                        <div class="p-3 rounded-2xl bg-gray-50/50 dark:bg-boxdark-2/50 border border-gray-50 dark:border-boxdark flex items-center justify-between mt-auto">
                            ...
                            @if($shipment->receiverCustomer && $shipment->receiverCustomer->phone)
                                <div class="flex gap-1">
                                    <a href="tel:{{ $shipment->receiverCustomer->phone }}" class="w-8 h-8 rounded-xl bg-white dark:bg-boxdark shadow-sm flex items-center justify-center text-gray-400 hover:text-primary transition-all active:scale-95 border border-gray-100 dark:border-boxdark-2">
                                        <span class="material-symbols-outlined text-[18px]">call</span>
                                    </a>
                                    <a href="https://wa.me/{{ preg_replace('/\D/', '', $shipment->receiverCustomer->phone) }}" target="_blank" class="w-8 h-8 rounded-xl bg-white dark:bg-boxdark shadow-sm flex items-center justify-center text-emerald-500 hover:bg-emerald-500 hover:text-white transition-all active:scale-95 border border-gray-100 dark:border-boxdark-2">
                                        <span class="material-symbols-outlined text-[18px]">chat</span>
                                    </a>
                                </div>
                            @endif
