...
@section('Breadcrumb', 'الإرساليات الواردة')
...
@section('content')
    ...
    <div class="pb-24 space-y-6 min-h-screen font-body lg:pb-12"
         dir="rtl"
         x-data="incomingPackagesRegistry()">
        ...
        <div class="grid grid-cols-1 gap-2 mx-auto max-w-7xl xl:grid-cols-4 md:gap-6">
            ...
            <a href="{{ $statusUrl('received_at_branch') }}"
                ...
                <div class="flex justify-center items-center w-12 h-12 text-purple-500 bg-purple-50 rounded-xl dark:bg-purple-500/10">
            ...
            <div class="flex flex-col gap-4 p-5 lg:hidden">
                @forelse($packages as $package)
                    @php
                        ...
                        $senderName = $package->senderBranch->name ?? ($package->senderOfficeBranch->name ?? 'غير محدد');
                    @endphp
                    ...
                    <div class="flex flex-col gap-4 p-5 rounded-2xl border border-gray-100 transition-all incoming-package-row bg-surface dark:bg-boxdark-2 dark:border-boxdark hover:border-primary/30 hover:shadow-sm"
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-4 border-t border-gray-100 dark:border-boxdark">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <span class="inline-flex w-fit items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-black {{ $currentStatusData['class'] }}">
                                ...
                                <td colspan="6" class="py-24 text-center">
                                    <div class="flex flex-col gap-4 justify-center items-center">
                                        <div class="flex justify-center items-center w-16 h-16 bg-gray-50 rounded-2xl border border-gray-100 dark:bg-boxdark-2 dark:border-boxdark">
                                            <span class="material-symbols-outlined text-[28px] text-gray-400">move_to_inbox</span>
                                        </div>
    ...
    <script>
        function incomingPackagesRegistry() {
            return {
                ...
                updateVisibility() {
                    this.$nextTick(() => {
                        this.visibleCount = document.querySelectorAll('.incoming-package-row:not([style*="display: none"])').length;
                    });
                }
            }
        }
