    ...
    <form action="{{ route('request.update', $shipment->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4"
                 x-data="customerPicker(
                    ...
                    @js([
                        ...
                        'name'  => old('sender_name', $shipment->sender_name),
                        'phone' => old('sender_phone', $shipment->sender_phone),
                    ])
                 )">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="sender_phone"
                        x-model="selectedPhone" @input="selectedId=''"
                        class="px-4 py-2.5 w-full h-11 text-sm text-gray-800 bg-transparent rounded-lg border border-gray-300 hover:border-brand-500 dark:bg-dark-900 shadow-theme-xs focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-600 dark:text-white"
                ...
                <!-- عدد قروف العسل -->
                <div class="mt-3">
                    <label class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">عدد قروف العسل</label>
            ...
            <div class="space-y-4"
                 x-data="customerPicker(
                    ...
                    @js([
                        ...
                        'name'  => old('receiver_name', $shipment->receiver_name),
                        'phone' => old('receiver_phone', $shipment->receiver_phone),
                    ])
                 )">
                ...
                <!-- عدد جوالين العسل -->
                <div class="mt-3">
                    <label class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">عدد جوالين العسل</label>
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 xl:grid-cols-2">
            <div class="space-y-4 w-full md:col-span-2">
                ...
                <div class="mt-3">
                    <label class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">الوزن (كجم)</label>
                    <input type="number" name="weight"
                        value="{{ old('weight', $shipment->weight) }}" step="0.01" min="0"
                        class="px-4 py-2.5 w-full h-11 text-sm text-gray-800 bg-transparent rounded-lg border border-gray-300 hover:border-brand-500 dark:bg-dark-900 shadow-theme-xs focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-600 dark:text-white"
                        placeholder="0.00">
                    @error('weight')
                        <div class="mt-1 text-sm text-error-600">{{ $message }}</div>
                ...
                <div class="mt-3">
                    <label class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">إجمالي المبلغ</label>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="p-4 mt-2 rounded-xl border border-gray-200 dark:border-gray-700"
                        ...
                        <div class="flex flex-wrap gap-6">
                            ...
                            <label class="flex relative gap-3 items-center text-sm font-medium cursor-pointer select-none">
                                <input class="sr-only" type="radio" name="prepaid_payment_method" value="bank_transfer"
                                    x-model="prepaid_method">
                                <span
