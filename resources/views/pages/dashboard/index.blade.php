...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-3 mb-6 xl:grid-cols-1" x-data="{ filterStatus: 'all' }">
                    ...
                    @forelse ($last24Shipments as $shipment)
                        <div class="flex flex-col gap-3 p-4 rounded-xl border border-gray-100 transition-opacity bg-gray-50/50 dark:bg-gray-800/20 dark:border-gray-800"
                            ...
                            <div class="flex gap-3 items-center mt-2">
                                <div
                                    class="flex justify-center items-center w-10 h-10 text-sm font-bold text-white rounded-full bg-brand-500 from-brand-50 to-brand-500 dark:from-brand-900 dark:to-brand-800 dark:text-brand-300">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="flex gap-1 items-center mt-0.5 text-xs text-brand-500">
                            ...
                            <div
                                class="flex justify-between items-end pt-3 mt-1 border-t border-gray-100 dark:border-gray-800">
                    ...
                    @empty
                        <div
                            ...
                            <div class="flex flex-col justify-center items-center">
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">لم يتم تسجيل شحنات خلال الـ 24
                                    ساعة الماضية</p>
                            </div>
                        </div>
                    @endempty
