...
<div x-show="showCreateModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    <div x-show="showCreateModal" x-transition:enter="transition ease-out duration-300"
        ...
        <form action="{{ route('offices.store') }}" method="POST" x-data="{ isSubmitting: false }"
            ...
            <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                <div class="flex gap-3 items-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">إضافة مكتب جديد</h3>
                </div>
            ...
            <div class="px-6 py-5 space-y-5">
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <div
                            ...
                            {{-- Phone number input --}}
                            <input id="office_phone" type="tel" x-model="localPhoneNumber" placeholder="780236551"
                                autocomplete="off"
                ...
                <div>
                    ...
                    <input type="text" id="office_address" name="address" value="{{ old('address') }}"
