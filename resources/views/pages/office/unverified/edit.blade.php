    ...
    <div class="space-y-6 font-body" dir="rtl">
        <div class="flex gap-4 items-center mb-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-bodydark">تحديث معلومات مكتب <span
                        class="font-bold text-primary">{{ $office->name }}</span> وفروعه.</p>
            </div>
        </div>

        <form action="{{ route('offices.update', $office->id) }}" method="POST" x-data="{ isSubmitting: false }"
            ...
            <div class="space-y-6">
                ...
                <div
                    ...
                    <div
                        class="flex gap-3 items-center px-6 py-5 border-b border-gray-100 bg-surface dark:bg-boxdark-2 dark:border-boxdark">
                        <div
                ...
                <div class="overflow-hidden bg-white rounded-3xl border border-gray-200 shadow-sm dark:bg-boxdark dark:border-boxdark-2"
                    ...
                    <div
                        class="flex justify-between items-center px-6 py-5 border-b border-gray-100 bg-surface dark:bg-boxdark-2 dark:border-boxdark">
                        <div class="flex gap-3 items-center">
                            ...
                            <h3 class="text-lg font-bold text-on-surface dark:text-white">تحديث الفروع <span
                    ...
                    <div class="p-6 space-y-6 md:p-8 bg-surface dark:bg-boxdark-2/50">
                        <template x-for="(branch, index) in branches" :key="index">
                            <div
                                class="relative p-6 bg-white rounded-2xl border border-gray-200 shadow-sm transition-all dark:bg-boxdark dark:border-boxdark hover:shadow-md hover:border-primary/30 dark:hover:border-primary/50">

                                <button type="button" @click="branches.splice(index, 1)" x-show="branches.length > 1"
                                    class="absolute top-4 left-4 p-2 text-gray-400 rounded-xl transition-all bg-surface hover:text-error hover:bg-error/10 dark:bg-boxdark-2 dark:hover:bg-error/20 dark:hover:text-error"
                                    title="حذف الفرع">
                                ...
                                <div class="flex gap-2 items-center mb-5">
                                    <span
                                        class="flex justify-center items-center w-6 h-6 text-xs font-bold rounded-full text-primary-hover bg-primary-container dark:bg-primary/20 dark:text-primary"
                                        x-text="index + 1"></span>
                                ...
                                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        <label
                                            class="block mb-2 text-sm font-semibold text-gray-700 dark:text-gray-300">اسم
                                            الفرع <span class="text-error">*</span></label>
                                        <div class="relative">
                                            <div
                                                class="flex absolute inset-y-0 right-0 items-center pr-3 text-gray-400 pointer-events-none">
                                    ...
                                    <div>
                                        ...
                                        <div x-data="phoneComponent(branch.phone)" class="relative">
                                            <input type="hidden" :name="`branches[${index}][phone]`"
                                                :value="localPhoneNumber ? selectedCountry?.dial_code.replace('+', '') +
                                                    localPhoneNumber : ''"
                                            ...
                                            <div
                                                ...
                                                <button type="button" @click="open = !open"
                                                    class="flex gap-2 items-center px-3 border-l border-gray-200 transition-colors shrink-0 hover:bg-gray-100 dark:border-boxdark dark:hover:bg-boxdark">
                                                    <template x-if="selectedCountry"><svg
                                                            class="w-5 h-auto rounded-sm shadow-sm" viewBox="0 0 36 24"
                                                ...
                                                <input type="tel" x-model="localPhoneNumber" placeholder="780236551"
                                                    class="px-4 w-full text-sm text-left text-gray-800 bg-transparent border-none dir-ltr focus:ring-0 dark:text-white">
                                            </div>
                                            {{-- Dropdown --}}
