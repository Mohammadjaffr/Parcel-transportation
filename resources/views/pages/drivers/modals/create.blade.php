{{-- ======================== Create Driver Modal ======================== --}}
{{-- نستخدم x-teleport="body" لنقل هذا العنصر بالكامل إلى نهاية الـ body، مما يحل مشكلة الـ z-index --}}
<template x-teleport="body">
    <div x-cloak x-show="showCreateModal" 
        ...
        <div x-show="showCreateModal" 
            ...
            <form action="{{ route('drivers.store') }}" method="POST" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
                @csrf
                ...
                <div class="space-y-5 text-right">
                    ...
                    {{-- حقل اسم السائق --}}
                    <div>
                        <label for="driver_name" class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">
                            اسم السائق <span class="text-red-500">*</span>
                        </label>
                        <input type="text" id="driver_name" name="name" value="{{ old('name') }}" required autocomplete="off" 
                               placeholder="أدخل اسم السائق ثلاثياً"
                    ...
                    <div x-data="{
                        ...
                        <label for="driver_phone" class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">
                        ...
                        <div class="flex overflow-hidden items-center w-full h-12 bg-gray-50 rounded-xl border border-gray-200 transition-all focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 dark:bg-gray-900 dark:border-gray-700 dark:focus-within:border-primary">
                            ...
                            {{-- حقل إدخال الرقم --}}
                            <input id="driver_phone" type="tel" x-model="localPhoneNumber" placeholder="771234567" autocomplete="off" required
