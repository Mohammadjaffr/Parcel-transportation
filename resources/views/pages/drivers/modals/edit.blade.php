        ...
        <form :action="editDriver.url" method="POST" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-xl bg-warning-50 dark:bg-warning-500/10 text-warning-500">
            ...
            <div class="px-6 py-5 space-y-5">
                ...
                <div>
                    ...
                    <div x-data="{
                    ...
                    }" x-init="if (typeof editDriver !== 'undefined' && editDriver.phone) parsePhone(editDriver.phone)"
                        class="relative">
                        ...
                        <div
                            ...
                            {{-- Phone number input --}}
                            <input id="edit_driver_phone" type="tel" x-model="localPhoneNumber" placeholder="780236551"
                                autocomplete="off"
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition
                            ...
                            <input type="text" x-model="search" placeholder="ابحث عن الدولة..."
                                class="w-full px-4 py-2 border-b dark:bg-gray-900 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-brand-500 text-sm h-8">
