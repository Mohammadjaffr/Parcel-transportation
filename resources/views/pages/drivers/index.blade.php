...
@section('content')
    ...
    <div x-data="{
        ...
        {{-- ================= Search & Data Section ================= --}}
        <div class="bg-white dark:bg-boxdark rounded-[2rem] border border-gray-100 dark:border-boxdark-2 shadow-sm overflow-visible transition-colors">

            {{-- Search Bar --}}
            <div class="p-5 bg-white border-b border-gray-100 dark:border-boxdark-2 dark:bg-boxdark rounded-t-[2rem]">
            ...
            <div class="flex flex-col gap-4 p-5 lg:hidden">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex gap-1.5 items-center mt-1 text-gray-500 dark:text-bodydark">
                                        ...
                                        <span class="font-mono text-xs font-bold tracking-wider dir-ltr">{{ $driver->phone }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @empty
                    <div class="flex flex-col gap-4 justify-center items-center py-16 text-center rounded-2xl border-2 border-gray-100 border-dashed bg-surface dark:bg-boxdark-2 dark:border-boxdark">
                        ...
                        <div>
                            <h3 class="mb-1 text-base font-bold text-gray-800 dark:text-white">لا توجد بيانات للسائقين</h3>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">لم نعثر على أي سائقين مسجلين في النظام حالياً.</p>
                        </div>
                    </div>
                @endforelse

                <div x-show="searchQuery !== '' && !Array.from(document.querySelectorAll('.lg\\:hidden > div[x-show]')).some(el => el.style.display !== 'none')"
                    style="display: none;"
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">لا يوجد نتائج تطابق بحثك.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden overflow-visible w-full lg:block">
                <table class="w-full text-right border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-boxdark-2">
                            ...
                            <tr x-show="searchQuery === '' || '{{ $driver->name }}'.includes(searchQuery) || '{{ $driver->phone }}'.includes(searchQuery)"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-4 items-center">
                                        ...
                                        <span class="text-sm font-black text-gray-800 dark:text-white">{{ $driver->name }}</span>
                                    </div>
                                </td>

                                <td class="px-6 py-4">
                                    <div class="flex gap-2 items-center text-gray-600 dark:text-gray-300">
                                        <span class="material-symbols-outlined text-[16px] text-gray-400 dark:text-gray-500">phone_iphone</span>
                                        <span class="font-mono text-xs font-bold tracking-wider dir-ltr">{{ $driver->phone }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex gap-3 justify-center items-center">
                                        ...
                                        <a href="https://wa.me/{{ ltrim($driver->phone, '+') }}" target="_blank" title="واتساب"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex gap-2 justify-center items-center">
                                        <button @click="openEditModal({{ $driver->id }}, {{ json_encode($driver->name) }}, {{ json_encode($driver->phone) }})" title="تعديل"
                                            class="flex justify-center items-center w-9 h-9 text-gray-400 bg-transparent rounded-lg transition-all dark:text-gray-500 hover:bg-gray-100 hover:text-primary dark:hover:bg-boxdark-2 dark:hover:text-primary active:scale-95">
                        ...
                        {{-- رسالة بحث الديسكتوب --}}
                        <tr x-show="searchQuery !== '' && !Array.from(document.querySelectorAll('tr.driver-row[x-show]')).some(el => el.style.display !== 'none')" style="display: none;" x-cloak>
                            <td colspan="4" class="py-24 text-center">
                                <div class="flex flex-col gap-4 justify-center items-center">
                                    ...
                                    <div>
                                        <h3 class="mb-1 text-base font-bold text-gray-800 dark:text-white">لا توجد نتائج مطابقة</h3>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">لم نعثر على أي سائق يطابق كلمة البحث.</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
