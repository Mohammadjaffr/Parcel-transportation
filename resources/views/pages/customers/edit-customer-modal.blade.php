                ...
                <div class="sm:col-span-1" x-data="{ open: false, search: '' }">
                    ...
                    <div class="relative">
                        <input type="hidden" name="phone"
                            :value="editCustomer.phone_country.dial_code.replace('+', '') + editCustomer.phone_local">
                        ...
                        <div
                            ...
                            <button type="button" @click="open = !open"
                                ...
                                <img :src="`https://flagcdn.com/w20/${editCustomer.phone_country.code.toLowerCase()}.png`"
                            ...
                            <input id="edit_phone_display" type="tel" x-model="editCustomer.phone_local"
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition
                            ...
                            <div class="overflow-y-auto max-h-48">
                                <template
                                    ...
                                    :key="country.code">
                                    <div @click="editCustomer.phone_country = country; open = false"
                ...
                <div class="sm:col-span-1" x-data="{ open: false, search: '' }">
                    ...
                    <div class="relative">
                        <input type="hidden" name="whatsapp_number"
                            :value="editCustomer.whatsapp_country.dial_code.replace('+', '') + editCustomer.whatsapp_local">

                        <div
                            class="flex h-11 w-full rounded-lg border border-gray-300 dark:border-gray-600 shadow-theme-xs">
                            <button type="button" @click="open = !open"
                                class="flex items-center gap-2 px-3 bg-gray-50 dark:bg-gray-700 rounded-r-lg border-l border-gray-300 dark:border-gray-600">
                                <img :src="`https://flagcdn.com/w20/${editCustomer.whatsapp_country.code.toLowerCase()}.png`"
                                    alt="Flag" class="w-5 h-auto">
                                <svg class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <input id="edit_whatsapp_display" type="tel" x-model="editCustomer.whatsapp_local"
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition
                            ...
                            <div class="overflow-y-auto max-h-48">
                                <template
                                    x-for="country in countries.filter(c => c.name.toLowerCase().includes(search.toLowerCase()) || c.dial_code.includes(search))"
                                    :key="country.code">
                                    <div @click="editCustomer.whatsapp_country = country; open = false"
                                        class="flex items-center gap-3 p-2 px-4 transition-colors duration-150 cursor-pointer hover:bg-sky-50 dark:hover:bg-gray-700">
                                        <img :src="`https://flagcdn.com/w20/${country.code.toLowerCase()}.png`" alt=""
                                            class="w-5">
                                        <span class="flex-grow text-sm font-medium text-gray-900 dark:text-gray-100"
