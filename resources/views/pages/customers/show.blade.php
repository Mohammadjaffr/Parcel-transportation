                                ...
                                <tr x-show="isVisible('{{ $status }}')" x-transition:enter="transition ease-out duration-300"
                                    ...
                                    <td class="px-6 py-4 align-top">
                                        <div class="flex gap-2 items-center">
                                            <div
                                                ...
                                                <svg class="mx-2 w-3 h-3 text-gray-400 rotate-180 rtl:rotate-0" fill="none"
                                    ...
                                    <td class="px-6 py-4 align-top">
                                        @if ($shipment->status !== 'cancelled')
                                            <a href="{{ route('shipments.show', $shipment->id) }}" title="عرض التفاصيل"
                                                class="inline-flex justify-center items-center w-8 h-8 bg-brand-50 text-brand-500 rounded-xl hover:bg-brand-500 hover:text-white transition-all hover:scale-110 shadow-sm border border-brand-100 hover:border-brand-500">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
