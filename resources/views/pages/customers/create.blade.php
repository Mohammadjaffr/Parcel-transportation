...
@section('content')
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
        <form method="POST" action="{{  route('customers.store') }}" class="space-y-6" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
            ...
            <div class="mt-8 pt-6  border-gray-200 dark:border-gray-700">
                <div class="flex justify-start gap-4">
                    ...
                    <button type="submit" :disabled="isSubmitting"
                        class="flex justify-center items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white font-medium px-6 py-2.5 rounded-lg transition-colors w-full disabled:opacity-75 disabled:cursor-not-allowed">
