    ...
    <div class="p-6 space-y-8 max-w-full mx-auto font-outfit">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 my-4">
            <div
                ...
                <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">إجمالي الشحنات الآجلة (شامل الجزئي)</p>
                <div class="flex items-center justify-between">
                    <h4 class="text-2xl font-bold text-gray-900 dark:text-white">
                        {{ number_format($summary['total_cod'], 2) }}</h4>
            ...
            <div
                class="bg-white dark:bg-gray-dark border border-gray-100 dark:border-gray-800 p-6 rounded-2xl shadow-theme-xs hover:shadow-theme-md transition-all">
                <p class="text-xs font-bold text-success-600/70 uppercase tracking-widest mb-4">تسويات مستلمة (نقد)</p>
                <div class="flex items-center justify-between">
                    <h4 class="text-2xl font-bold text-success-600 dark:text-success-500">
                        {{ number_format($summary['total_settle_in'], 2) }}</h4>
            ...
            <div
                class="bg-white dark:bg-gray-dark border border-gray-100 dark:border-gray-800 p-6 rounded-2xl shadow-theme-xs hover:shadow-theme-md transition-all">
                <p class="text-xs font-bold text-error-600/70 uppercase tracking-widest mb-4">تسويات مدفوعة (نقد)</p>
                <div class="flex items-center justify-between">
                    <h4 class="text-2xl font-bold text-error-600 dark:text-error-500">
                        {{ number_format($summary['total_settle_out'], 2) }}</h4>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-50 dark:divide-gray-800">
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="p-6 text-center text-xs text-gray-400">لا توجد حركات.</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
            ...
            <div
                ...
                <div class="p-6 border-b border-gray-50 dark:border-gray-800">
                    <h3 class="text-sm font-bold text-gray-800 dark:text-white">سجل الحركات المالية التفصيلي</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-50 dark:divide-gray-800">
                        <thead class="bg-gray-50/50 dark:bg-gray-900/30">
