    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">نظرة عامة على أرصدة الفروع والتسويات والشحنات
                    الآجلة.</p>
            </div>
        </div>
                        ...
                        @foreach ($branchesSummary as $row)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    @if ($net > 0)
                                        <span
                                            class="text-xs bg-success-100 dark:bg-success-800 text-success-700 dark:text-success-300 px-2 py-1 rounded-full">
                                            لنا {{ number_format($net, 2) }} ر.ي
                                        </span>
                                    @elseif ($net < 0)
                                        <span
                                            class="text-xs bg-error-100 dark:bg-error-800 text-error-700 dark:text-error-300 px-2 py-1 rounded-full">
