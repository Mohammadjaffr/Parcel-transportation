        ...
        <div class="px-4 mt-6 space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                @if (isset($company))
                    ...
                    @empty
                        <div
                            class="col-span-full py-10 flex flex-col items-center justify-center bg-white rounded-[2rem] border border-dashed border-slate-200">
                            ...
                            <div class="relative cursor-pointer group">
                                ...
                                <div
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm font-bold text-emerald-600 truncate font-headline"
