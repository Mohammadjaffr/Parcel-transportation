...
@section('content')
    ...
    <div class="space-y-6" x-data="{
        ...
        openPaymentModal(shipmentId, remainingAmount) {
            this.paymentData.shipmentId = shipmentId;
            this.paymentData.amount = remainingAmount;
            this.paymentData.maxAmount = remainingAmount;
        ...
        paymentsList: @json($shipment->payments),
        ...
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col gap-6 justify-between md:flex-row md:items-center">
                <div class="flex gap-4 items-center">
                    ...
                    <div>
                        <div class="flex gap-3 items-center">
                            ...
                            <span
                                class="px-2.5 py-0.5 text-xs font-medium rounded-full bg-brand-50 text-brand-500 dark:bg-brand-500/10 dark:text-brand-400">
                ...
                <div class="flex flex-wrap gap-3 items-center">
                    ...
                    <a href="{{ route('shipment.printThermal', $shipment->id) }}" target="_blank"
                        class="flex gap-2 items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-lg border border-gray-300 dark:text-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-500 dark:hover:bg-gray-700">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z">
                ...
                <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <a href="{{ route('whatsapp.sender', $shipment->id) }}" target="_blank"
                                    class="transition-colors text-success-500 hover:text-success-500">
                        ...
                        <div class="flex gap-4 items-center">
                            <div class="flex-shrink-0">
                                <span
                                    class="inline-flex justify-center items-center p-3 rounded-lg bg-success-50 text-success-500 dark:bg-success-500/10 dark:text-success-400">
                    ...
                    <div
                            ...
                            <div class="flex gap-2 items-center">
                                @if ($shipment->receiverCustomer)
                                    <a href="{{ route('customers.show', $shipment->receiverCustomer->id) }}"
                                        class="p-1.5 rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                        title="عرض تفاصيل العميل">
                                        <svg class="w-6 h-6 transition-colors text-brand-500 group-hover:text-brand-500"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                        ...
                        <div class="flex gap-4 items-center">
                            <div class="flex-shrink-0">
                                <span
                                    class="inline-flex justify-center items-center p-3 rounded-lg text-brand-500 bg-brand-50 dark:bg-brand-500/10 dark:text-brand-400">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                                <div class="mb-1 text-sm text-gray-500 dark:text-gray-400">الإجمالي</div>
                            ...
                            {{-- Payment Actions for Customer Credit --}}
                            @if ($shipment->payment_method === 'customer_credit')
                                ...
                                @endif
                            @elseif($shipment->payment_method === 'partial_payment' && $paidAmount > 0)
                                <div class="pt-3 border-t border-gray-100 dark:border-gray-700">
