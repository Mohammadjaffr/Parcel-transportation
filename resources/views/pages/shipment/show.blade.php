                            ...
                            <div class="flex gap-2 items-center">
                                @if ($shipment->senderCustomer)
                                    <a href="{{ route('customers.show', $shipment->senderCustomer->id) }}"
                                        ...
                                        <svg class="w-4 h-4 text-gray-400 transition-colors group-hover:text-brand-500"
                                ...
                                <a href="{{ route('whatsapp.sender', $shipment->id) }}" target="_blank"
                                    class="transition-colors text-success-500 hover:text-success-600">
                                ...
                                @if ($isUnpaid)
                                    <div class="pt-3 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <button @click="openPaymentModal({{ $shipment->id }}, {{ $remainingAmount }})"
                                            class="flex gap-1.5 justify-center items-center px-3 w-full h-10 text-sm font-bold text-white rounded-lg shadow-sm transition-all bg-brand-500 hover:bg-brand-600">
