...
<div x-show="cancelModalOpen" class="flex fixed inset-0 justify-center items-center p-4 z-99999" x-cloak x-transition>
    ...
    <div class="relative p-6 w-full max-w-md bg-white rounded-2xl shadow-2xl dark:bg-gray-800">
        ...
        <form action="{{ route('shipment.cancel', $shipment->id) }}" method="POST" @submit="cancelLoading = true">
            @csrf
            @method('PATCH')
            <div class="mb-6">
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" :disabled="cancelLoading"
                    class="flex flex-1 gap-2 justify-center items-center px-4 py-3 text-sm font-bold text-white rounded-xl bg-error-500 hover:bg-error-600 disabled:opacity-50 disabled:cursor-not-allowed">
