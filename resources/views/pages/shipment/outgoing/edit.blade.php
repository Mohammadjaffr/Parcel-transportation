...
<div class="pb-24 min-h-screen bg-surface dark:bg-boxdark-2 font-body lg:pb-12" dir="rtl"
    x-data="{ paymentMethod: '{{ old('payment_method', $shipment->payment_method) }}', isSubmitting: false }">
                                ...
                                <div>
                                    ...
                                    <div class="flex overflow-visible relative items-center bg-white rounded-xl ring-1 ring-gray-200 transition-all group dark:bg-boxdark dark:ring-boxdark-2 focus-within:ring-2 focus-within:ring-primary/40 focus-within:border-primary"
                                        ...
                                        <input type="tel" x-model="localPhoneNumber" @input="searchCustomer"
                                            ...
                                            @click.away="showCustomerDropdown = false" placeholder="7XXXXXXXX" required
                        ...
                        <div class="flex flex-col gap-2" x-data="{
                            ...
                            <div class="relative z-[40]">
                                ...
                                <input type="text" name="package_type" x-model="packageType" @focus="isOpen = true"
                                    @click.outside="isOpen = false" placeholder="اختر أو اكتب النوع..."
