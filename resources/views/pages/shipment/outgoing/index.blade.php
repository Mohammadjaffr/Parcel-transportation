                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <div x-data="{ openMenu: false }" class="relative">
                            ...
                            <div x-show="openMenu" x-transition.opacity.duration.200ms x-cloak
                                ...
                                <a href="#" class="flex gap-2.5 items-center px-4 py-2 text-xs font-bold text-gray-600 transition-colors hover:bg-surface hover:text-primary dark:text-gray-300 dark:hover:bg-boxdark">
