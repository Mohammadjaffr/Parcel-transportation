...
@section('content')
<style>
    /* تلوين الصفحة النشطة (الخلفية برتقالي والنص أبيض ناصع) */
    .pagination-container span[aria-current="page"] > span {
        background-color: #ee8f4c !important; /* لون برتقالي */
        border-color: #ee8f4c !important;
        color: #ffffff !important; /* نص أبيض */
        font-weight: 900 !important;
    }

    /* تلوين أرقام الصفحات العادية (غير النشطة) والأسهم */
    .pagination-container a, 
    .pagination-container span[aria-disabled="true"] > span {
        color: #ee8f4c !important; /* نص برتقالي */
        border-color: #fed7aa !important; /* إطار برتقالي فاتح */
    }

    /* تأثير عند تمرير الماوس (Hover) على الأرقام */
    .pagination-container a:hover {
        background-color: #fff7ed !important; /* خلفية برتقالية فاتحة جداً */
        color: #ea580c !important; /* برتقالي غامق */
    }

    /* تدوير الحواف قليلاً لتتناسب مع تصميمك (اختياري) */
    .pagination-container .isolate > * {
        border-radius: 0.5rem !important;
        margin: 0 0.125rem;
    }
    
    /* إزالة ظل لارافل الافتراضي המزعج */
    .pagination-container .isolate {
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <div x-data="{ openMenu: false }" class="relative">
                        ...
                        <div x-show="openMenu" x-transition.opacity.duration.200ms x-cloak
                            ...
                            <a href="{{ route('shipment.show', $shipment->id) }}" class="flex gap-2.5 items-center px-4 py-2 text-xs font-bold transition-colors text-slate-600 hover:bg-slate-50 hover:text-primary">
 ...
 <div class="flex col-span-full justify-center items-center pt-6 mt-4 w-full">
    <div class="w-full p-4 transition-all bg-white border border-orange-400 shadow-sm pagination-container rounded-[2rem] dark:bg-boxdark dark:border-gray-800 hover:shadow-md lg:w-fit lg:min-w-[50%]">
        <div class="flex overflow-x-auto justify-center w-full text-orange-500 custom-scrollbar">
            {{ $shipments->links() }}
        </div>
    </div>
</div>

{{-- ستايل مخصص لإجبار لارافل على استخدام ألوانك (برتقالي وأبيض) --}}
