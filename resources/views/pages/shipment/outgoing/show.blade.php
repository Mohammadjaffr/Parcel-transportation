                ...
                <div class="flex flex-wrap gap-3 items-center">
                    ...
                    @php
                        $statusConfig = [
                            ...
                            'delivered'  => ['bg' => 'bg-success-50 dark:bg-success-500/10', 'text' => 'text-success-600 dark:text-success-400', 'label' => 'تم التسليم', 'dot' => 'bg-success-500', 'border' => 'border-success-200 dark:border-success-500/20'],
                        ...
                        <div class="flex justify-between items-start mb-5">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <a href="{{ route('whatsapp.sender', $shipment->id) }}" target="_blank" title="مراسلة واتساب"
                                    class="flex justify-center items-center w-8 h-8 rounded-lg transition-colors bg-success-50 text-success-500 hover:bg-success-100 dark:bg-success-500/10">
                                    {{-- أيقونة واتساب مخصصة --}}
                ...
                <div class="p-6 bg-white border border-gray-100 shadow-sm rounded-[2rem] dark:bg-boxdark dark:border-gray-800">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                            ...
                            @php
                                $debtConfig = [
                                    'fully_paid'     => ['text' => 'text-success-600 dark:text-success-400', 'label' => 'مدفوع بالكامل'],
                        ...
                        @if ($shipment->payment_method === 'partial_payment' && $paidAmount > 0)
                            <div class="flex justify-between items-center pt-3">
                                ...
                                <span class="font-mono text-lg font-black text-success-500">
