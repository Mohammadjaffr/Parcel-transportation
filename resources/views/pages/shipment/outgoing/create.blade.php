...
@section('Breadcrumb', 'إرسال طرد جديد')

@section('content')
    <div x-data="{ paymentMethod: 'prepaid' }"
        class="flex relative flex-col gap-6 p-4 rounded-3xl bg-slate-50/50 lg:p-6">
            ...
            <div class="bg-white p-5 rounded-[1.75rem] border border-slate-50 shadow-[0_8px_30px_rgb(0,0,0,0.03)]">
                ...
                <div class="space-y-6">
                    ...
                    <div x-data="customerSelect({{ $customers }}, @js(array_values(config('countries', []))))"
                        class="relative z-50 p-4 rounded-2xl border bg-slate-50 border-slate-100">
                        <span
                    ...
                    {{-- ================= المستلم ================= --}}
                    <div x-data="customerSelect({{ $customers }}, @js(array_values(config('countries', []))))"
                        class="relative z-40 p-4 rounded-2xl border bg-slate-50 border-slate-100">
                        <span
