    ...
    <table style="width: 100%; margin-bottom: 10px;">
        <tr>
            ...
            <td style="width: 30%; text-align: center; position: relative;">
                <img src="{{ public_path('images/new.svg') }}" style="width: 120px;">
            </td>
        ...
        <table style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
            <tr>
                ...
                <td style="width: 45%; text-align: right;">
                    ...
                    <span class="dotted-line" style="width: 180px;">
        ...
        <table style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
            <tr>
                <td style="width: 45%; text-align: right;">
                    ...
                    <span class="dotted-line" style="width: 60px;">
                        {{ $shipment->no_gallons_honey ?: '....' }}
                    </span>
                </td>
                <td style="width: 55%; text-align: right;">
                    <strong>الجهة / من</strong>
                    <span class="dotted-line" style="width: 80px;">
            ...
            <tr>
                <td colspan="2" style="text-align: right;">
                    ...
                    <span class="dotted-line" style="width: 400px;">
