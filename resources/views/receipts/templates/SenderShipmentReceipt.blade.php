    ...
    <div class="bg-gradient-to-l from-orange-50/50 to-white p-6 sm:p-8 border-b border-slate-100">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
            ...
            <div class="text-right">
                <div class="inline-flex items-center px-3 py-1.5 bg-orange-50 text-orange-700 rounded-xl font-bold text-xs border border-orange-100">
            ...
            <div class="bg-emerald-50/50 rounded-2xl border border-emerald-100 p-5">
                <div class="flex items-center gap-2 mb-3">
                    <div class="w-8 h-8 rounded-lg bg-emerald-100 flex items-center justify-center">
                        <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                    </div>
