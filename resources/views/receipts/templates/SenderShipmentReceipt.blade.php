...
<head>
    ...
    <style>
        ...
        body {
            font-family:
                {!! $design['font_family'] ?? "'aealarabiya', 'dejavusans', sans-serif" !!}
            ;
            font-size: 10pt;
            color: #334155;
            direction: rtl;
...
<body>
        ...
        <tr>
            <td width="35%" align="right" valign="top">
                <span class="text-2xl font-bold text-brand"
                    style="line-height: 1;">{{ $company['name'] ?? 'الشركة العالمية' }}</span><br>
                <br><br>
                <span class="text-sm font-bold text-slate-500" style="letter-spacing: 0.5px;">للنقل والشحن السريع</span>
                <br><br>
                <span class="text-xs text-slate-400">تاريخ الطباعة: <span
                        dir="ltr">{{ $print_date ?? date('Y-m-d H:i') }}</span></span>
            </td>
            ...
            <td width="35%" align="center" valign="top" style="line-height: 1.6;">
                ...
                @if(!empty($company['other_phones']))
                    <div class="text-xs text-slate-700" style="margin-bottom: 4px;">
                        ...
                        <span dir="ltr" class="font-bold text-brand"
                            style="line-height: 1.6;">{{ $company['other_phones'] }}</span>
                    </div>
                @endif

                <div class="text-xs font-bold text-slate-900" style="margin-top: 6px;">خدمة الشحن إلى جميع المحافظات
                    ودول الخليج</div>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" cellpadding="12" cellspacing="0" border="0" class="bg-slate-50"
        ...
        <tr>
            ...
            <td width="34%" align="center" valign="middle"
                style="border-right: 1px solid #e2e8f0; border-left: 1px solid #e2e8f0;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td width="48%" valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td height="4" class="bg-brand"></td>
                    </tr>
                    <tr>
                        <td class="bg-slate-50" style="padding: 16px; border: 1px solid #f1f5f9; border-top: none;">
                            <div class="text-base font-bold text-slate-900"
                                style="margin-bottom: 12px; text-align: center;">بيانات المرسل</div>
            ...
            <td width="48%" valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td height="4" class="bg-slate-800"></td>
                    </tr>
                    <tr>
                        <td class="bg-slate-50" style="padding: 16px; border: 1px solid #f1f5f9; border-top: none;">
                            <div class="text-base font-bold text-slate-900"
                                style="margin-bottom: 12px; text-align: center;">بيانات المستلم</div>
                            <table width="100%" cellpadding="6" cellspacing="0" border="0">
                                <tr>
                                    <td width="25%" align="right" class="label">الاسم:</td>
    ...
    <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td width="35%" align="right" class="value" style="border-bottom: 1px solid #f1f5f9;">
                {{ $package_type ?? '---' }}</td>
        ...
        @if(isset($honey_details) && $honey_details)
            <tr>
                <td width="15%" align="right" class="font-bold label text-brand" style="border-bottom: 1px solid #f1f5f9;">
                    تفاصيل إضافية:</td>
