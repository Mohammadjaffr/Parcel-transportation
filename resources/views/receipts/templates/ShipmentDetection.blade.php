    ...
    <div
        ...
        <div class="bg-gradient-to-l from-indigo-50/50 to-white p-6 sm:p-8 border-b border-slate-100">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div class="flex items-center gap-4">
                    ...
                    @endif
                    <div>
                        <h1 class="text-2xl font-black text-slate-800 tracking-tight">{{ $company['name'] ?? 'شركة مرسال' }}
                        </h1>
        ...
        <div class="p-6 sm:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <div class="bg-indigo-50/50 rounded-2xl border border-indigo-100 p-5">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-sm font-bold text-indigo-600 uppercase tracking-wider">بيانات الإرسالية</h3>
                    </div>
                    <div class="space-y-2">
                ...
                <div class="bg-slate-50/50 rounded-2xl border border-slate-200 p-5">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-sm font-bold text-slate-600 uppercase tracking-wider">بيانات السائق</h3>
                    </div>
                    <div class="space-y-2">
                        <div class="flex justify-between">
            ...
            <div class="mb-8">
                ...
                <div class="rounded-2xl border border-slate-200 overflow-x-auto">
                        ...
                        <tbody>
                            @forelse($shipments ?? [] as $shipment)
                                <tr class="transition-colors hover:bg-slate-50">
                                    ...
                                    <td class="text-center font-black text-slate-800" dir="ltr">{{ $shipment['total_amount'] }}
                                    </td>
                    ...
                    @if(!empty($shipments))
                        <div
                            class="bg-slate-50 border-t border-slate-200 p-4 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center divide-x divide-x-reverse divide-slate-200">
                            <div>
            ...
            <div class="grid grid-cols-3 gap-8 mt-12 mb-4">
                ...
                <div class="text-center">
                    <p class="text-sm font-bold text-slate-500 mb-8">ختم الفرع المستلم</p>
                    <div class="border-b border-dashed border-slate-300 w-3/4 mx-auto"></div>
                </div>
            </div>
        </div>
