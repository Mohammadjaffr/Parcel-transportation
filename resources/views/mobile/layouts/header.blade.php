        ...
        <button @click="profileOpen = !profileOpen; notifOpen = false"
            ...
            <div class="flex flex-col min-w-0">
                ...
                <div class="flex items-center gap-1">
                    <span class="font-headline font-bold text-sm text-slate-900 tracking-tight truncate max-w-[120px] xs:max-w-[150px]">
                        {{ Auth::user()->name }}
                    </span>
        ...
        <div x-show="profileOpen" @click.outside="profileOpen = false"
            ...
            <div class="p-5 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-b border-primary/10">
                <div class="flex gap-3 items-center mb-3">
                    <div class="w-10 h-10 rounded-xl bg-white text-primary flex items-center justify-center shadow-sm border border-primary/10 shrink-0">
