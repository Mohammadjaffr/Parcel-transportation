            ...
            <div
                ...
                <form action="{{ route('passengers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-2xl bg-gray-50/50 dark:bg-boxdark-2/50 border border-gray-100 dark:border-boxdark-2">
                            <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="col-span-1">
                                <label
                                    class="block mb-2 text-sm font-bold text-gray-600 dark:text-gray-300 whitespace-nowrap">عمولة
                            ...
                            <div class="col-span-1">
                                <label
                                    class="block mb-2 text-sm font-bold text-gray-600 dark:text-gray-300 text-ellipsis overflow-hidden whitespace-nowrap"
                                    title="عمولة مكاتب أخرى">عمولة أخرى <span class="text-error">*</span></label>
