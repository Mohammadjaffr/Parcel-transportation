            ...
            <form :action="editPassengerData.url" method="POST" class="px-2 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="day" x-model="editPassengerData.day" required placeholder="مثال: الأحد"
                                class="px-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white ring-slate-100 focus:ring-2 focus:ring-primary/20 font-headline">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="passenger_number" x-model="editPassengerData.passenger_number" required placeholder="أدخل رقم الراكب"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location" x-model="editPassengerData.location" required placeholder="أدخل المكان"
                            class="pr-12 pl-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white ring-slate-100 focus:ring-2 focus:ring-primary/20 font-headline">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="count" x-model="editPassengerData.count" required placeholder="عدد الركاب"
                                class="px-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white ring-slate-100 focus:ring-2 focus:ring-primary/20 font-headline">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="total_commission" x-model="editPassengerData.total_commission" step="0.01" required placeholder="العمولة"
                                class="px-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white ring-slate-100 focus:ring-2 focus:ring-primary/20 font-headline">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="broker" x-model="editPassengerData.broker" placeholder="اسم الوسيط (اختياري)"
                            class="pr-12 pl-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white ring-slate-100 focus:ring-2 focus:ring-primary/20 font-headline">
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-slate-100 relative">
                    ...
                    <div x-data="driverSelect({ 
                        ...
                        <div x-show="showDriverDropdown && phone.length > 0 && !selectedDriverId"
                            @click.outside="showDriverDropdown = false"
...
<div x-show="showDeleteModal" x-cloak
    ...
    <div class="relative w-full bg-white rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] p-6 pb-12 max-w-xl mx-auto border-t border-white/20 pointer-events-auto text-center">
        ...
        <p class="mb-8 text-sm font-semibold leading-relaxed text-slate-500">
            ...
            <span class="text-base font-bold text-slate-800 font-headline" x-text="deletePassengerData.passenger_number"></span>؟<br>
