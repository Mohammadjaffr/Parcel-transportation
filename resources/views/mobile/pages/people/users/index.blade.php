            ...
            <div
                ...
                <form @submit.prevent="submitForm('{{ route('users.store') }}', 'POST', createUserData)"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select x-model="createUserData.branch_id"
                                class="pr-12 pl-4 w-full h-14 text-sm rounded-2xl border-none ring-1 transition-all outline-none bg-slate-50 focus:bg-white font-headline appearance-none"
                                :class="errors.branch_id ? 'ring-red-300 focus:ring-red-400' : 'ring-slate-100 focus:ring-2 focus:ring-primary/20'">
                            ...
                            <span
                                class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-slate-400 pointer-events-none">expand_more</span>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-slate-400"
                                :class="errors.phone ? 'text-red-400' : ''">phone</span>
