...
<div class="flex flex-col gap-6">
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <a href="{{ route('drivers.index') }}" class="flex gap-5 items-center p-6 rounded-3xl border shadow-sm transition-all bg-surface-container-lowest border-slate-100 active:scale-95 group">
        ...
        <a href="{{ route('users.index') }}" class="flex gap-5 items-center p-6 rounded-3xl border shadow-sm transition-all bg-surface-container-lowest border-slate-100 active:scale-95 group">
        ...
        @endif
        <a href="{{ route('customers.index') }}" class="flex gap-5 items-center p-6 rounded-3xl border shadow-sm transition-all bg-surface-container-lowest border-slate-100 active:scale-95 group">
            <div class="flex justify-center items-center w-14 h-14 rounded-2xl transition-colors bg-tertiary-fixed/30 text-tertiary group-hover:bg-tertiary group-hover:text-white">
