                    ...
                    <div class="flex justify-between items-start p-5">
                        ...
                        <div class="flex gap-2 items-center">
                            ...
                            @if($shipment->status == 'pending')
                                <span
                                    class="px-2.5 py-1 rounded-full text-[10px] font-black bg-amber-50 text-amber-600 ring-1 ring-amber-500/20 ring-inset">قيد
                                    الانتظار</span>
                            ...
                            @elseif($shipment->status == 'delivered')
                                <span
                                    class="px-2.5 py-1 rounded-full text-[10px] font-black bg-emerald-50 text-emerald-600 ring-1 ring-emerald-500/20 ring-inset">تم
                                    التسليم</span>
                            @else
                                <span
                                    class="px-2.5 py-1 rounded-full text-[10px] font-black bg-slate-50 text-slate-500 ring-1 ring-slate-500/20 ring-inset">ملغي
                                    / مرتجع</span>
                            @endif
                            ...
                            <div x-data="{ openMenu: false }" class="relative">
                                ...
                                <div x-show="openMenu" x-transition.opacity.duration.200ms x-cloak
                                    ...
                                    {{-- عرض التفاصيل (يظهر دائماً لجميع الحالات) --}}
                        ...
                        <div class="flex gap-4 justify-between items-start">
                            ...
                            <div class="flex gap-3 items-stretch w-1/2">
                                ...
                                <div class="flex flex-col items-center mt-1">
                                    ...
                                    <div
                                        class="w-2.5 h-2.5 rounded-full border-[2.5px] border-primary bg-white z-10 shadow-[0_0_8px_rgba(247,144,9,0.4)]">
                                    </div>
                                </div>
