                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <span
                                    class="block mt-0.5 text-xs font-medium text-right text-slate-500 dir-ltr"><x-phone-number
                                        :value="$shipment->senderCustomer?->phone ?? '---'"
                                        class="text-[11px] font-bold text-gray-500 dark:text-bodydark" /></span>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <span
                                    class="block mt-0.5 text-xs font-medium text-right text-primary/70 dir-ltr"><x-phone-number
                                        :value="$shipment->receiverCustomer?->phone ?? '---'"
                                        class="text-[11px] font-bold text-gray-500 dark:text-bodydark" /></span>
                            </div>
                        ...
                        <div class="flex gap-3 items-center">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] font-bold text-slate-500 dir-ltr text-right mt-0.5">
                                    <x-phone-number :value="$shipment->package->driver->phone ?? '---'"
            ...
            <div class="p-4 space-y-4 rounded-2xl border bg-slate-50/50 border-slate-100">
                ...
                @if ($shipment->payment_method == 'partial_payment')
                    <div class="flex justify-between items-center">
                        ...
                        <span
                            class="text-sm font-black text-emerald-600">{{ number_format($shipment->partial_amount, 0) }}
                ...
                @elseif($shipment->payment_method == 'cod')
                    ...
                    <div class="flex justify-between items-end">
                        ...
                        <span class="text-2xl font-black text-rose-600">{{ number_format($shipment->total_amount, 0) }}
                            <span class="text-xs font-bold text-rose-400">ريال</span></span>
                    </div>
                @endif
            </div>
