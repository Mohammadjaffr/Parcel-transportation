...
@section('content')
    <div class="flex flex-col gap-6 px-4 pb-24 pt-4 min-h-screen bg-slate-50/50">
        ...
        <div class="space-y-4">
                ...
                <a href="{{ route('shipmentpackage.incoming.show', $package->id) }}"
                    ...
                    <div class="p-4 pr-5">
                        <div class="flex justify-between items-start mb-3">
                            <div>
                                <span class="text-xs font-black text-slate-400 uppercase tracking-wider mb-1 block">رقم
                                    الإرسالية</span>
                        ...
                        <div class="flex items-center gap-2 mb-3 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                            ...
                            <div class="flex-1">
                                <p class="text-[9px] font-bold text-slate-400">واردة من</p>
                        ...
                        <div class="flex items-center justify-between border-t border-slate-100 pt-3">
                            <div class="flex items-center gap-1.5 text-slate-500">
                                ...
                                <span
                                    class="text-[11px] font-bold truncate max-w-[100px]">{{ $package->driver->name ?? 'سائق غير محدد' }}</span>
                            </div>
            ...
            @empty
                <div
                    class="py-16 flex flex-col items-center justify-center bg-white rounded-[2rem] border-2 border-dashed border-slate-200">
