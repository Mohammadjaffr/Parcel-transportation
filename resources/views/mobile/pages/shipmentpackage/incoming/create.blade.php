            ...
            <form id="incomingPackageForm" action="{{ route('shipmentpackage.incoming.store') }}" method="POST"
                ...
                <div class="lg:col-span-5 flex flex-col gap-6 lg:sticky lg:top-[5.5rem] z-30">
                    ...
                    <div
                        ...
                        <div class="relative z-10 p-5 space-y-6 md:p-6">
                            ...
                            <div>
                                ...
                                @error('tracking_number') <p class="mt-2 text-xs font-bold text-error">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div x-data="{
                                ...
                                <div>
                                    ...
                                    @error('office_id') <p class="mt-2 text-xs font-bold text-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div x-show="selectedOffice" x-transition:enter.duration.300ms x-cloak>
                                    ...
                                    @error('sender_office_branch_id') <p class="mt-2 text-xs font-bold text-error">
                                        {{ $message }}
                                    </p> @enderror
                                </div>
                            </div>
                    ...
                    " {{-- 2. تحديد الحد الأقصى للمتصفح --}} :maxlength="selectedCountry?.dial_code === '+967' ? 9 : 15"
                                    ...
                                    @error('driver_phone') <p class="mt-2 text-xs font-bold text-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    @error('driver_name') <p class="mt-2 text-xs font-bold text-error">{{ $message }}</p>
                                    @enderror
                                </div>
                            </div>
                                ...
                                <div @click="activeItem = activeItem === index ? null : index"
                                    ...
                                    <div class="flex gap-4 items-center">
                                        <div class="flex justify-center items-center w-8 h-8 text-xs font-black rounded-full transition-colors shrink-0"
                                            :class="activeItem === index ? 'bg-primary text-white shadow-sm shadow-primary/30' : 'bg-surface dark:bg-boxdark-2 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-boxdark'"
                                            x-text="index + 1">
                                        </div>
                                    ...
                                    <div class="p-5 space-y-6 md:p-6">
                                        ...
                                        <div>
                                            <label class="block mb-2 text-xs font-bold text-gray-600 dark:text-gray-300">رقم
                                                البوليصة (السند) <span class="text-error">*</span></label>
                                        ...
                                        <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                                            ...
                                            <div class="p-4 space-y-4 rounded-2xl border border-gray-100 md:p-5 bg-surface dark:bg-boxdark-2 dark:border-boxdark"
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        class="flex overflow-visible items-center w-full h-12 bg-white rounded-xl border border-gray-200 transition-all dark:bg-boxdark dark:border-boxdark-2 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20">
                ...
                " {{-- 2. إيقاف لوحة المفاتيح من كتابة أكثر من 9 أرقام لليمن --}}
                                                        ...
                                                        <button type="button" @click="sdOpen = !sdOpen"
                                                            class="flex gap-2 items-center px-3 h-full rounded-l-xl border-r border-gray-200 transition-colors bg-surface dark:bg-boxdark-2 dark:border-boxdark shrink-0 hover:bg-gray-100 dark:hover:bg-boxdark">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" :name="`items[${index}][sender_name]`"
                                                        x-model="item.sender_name" placeholder="اسم المرسل"
