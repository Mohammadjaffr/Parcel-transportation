    ...
    <div class="min-h-screen bg-surface dark:bg-boxdark-2 font-body" dir="rtl">
        ...
        <div class="p-4 mx-auto mt-4 max-w-7xl md:p-6">
            ...
            <form id="incomingPackageForm" action="{{ route('shipmentpackage.incoming.store') }}" method="POST"
                @submit="isSubmitting = true" class="grid grid-cols-1 gap-6 items-start lg:grid-cols-12"
                x-data="{
                    isSubmitting: false,
                    activeItem: 0,
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    <input type="text" name="tracking_number" value="{{ old('tracking_number') }}"
                                        required placeholder="مثال: PKG-1001"
                            ...
                            <div :class="errorIndices.includes(index) ? 'border-error shadow-sm' : (activeItem === index ?
                                    ...
                                    <div class="flex gap-4 items-center">
                                        ...
                                        <div class="flex flex-col">
                                            <h4 class="text-sm font-black transition-colors font-headline"
                                                :class="activeItem === index ? 'text-primary' :
                                                    'text-on-surface dark:text-white'"
                                                x-text="item.bond_number || 'طرد جديد (بدون رقم)'"></h4>
                                            <p class="text-[10px] font-bold mt-0.5"
                                                :class="activeItem === index ? 'text-gray-500 dark:text-bodydark' :
                                ...
                                <div x-show="activeItem === index" x-collapse>
                                    <div class="p-5 space-y-6 md:p-6">
                                        ...
                                        <div>
                                            <label
                                                class="block mb-2 text-xs font-bold text-gray-600 dark:text-gray-300">رقم
                                            ...
                                            <div class="p-4 space-y-4 rounded-2xl border border-gray-100 md:p-5 bg-surface dark:bg-boxdark-2 dark:border-boxdark"
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        ...
                                                        {{-- Input --}}
                                                        <input type="tel" x-model="sdLocal"
                                                            @input="
                                                        ...
                                                        {{-- Country Dropdown --}}
                                                        <div x-show="sdCountryOpen" @click.outside="sdCountryOpen = false" x-transition
                                                            x-cloak
                                                            class="absolute z-[60] left-0 right-0 mt-2 top-full max-h-60 bg-white dark:bg-boxdark-2 rounded-xl border border-gray-100 dark:border-boxdark shadow-xl custom-scrollbar overflow-hidden">
                                                            <div class="p-2 border-b border-gray-50 dark:border-boxdark">
                                                        ...
                                                        {{-- Dropdown --}}
                                                        <div x-show="sdOpen && sdLocal.trim().length > 0" x-transition x-cloak dir="rtl"
                                                            @click.outside="sdOpen = false"
                                            ...
                                            <div class="p-4 space-y-4 rounded-2xl border border-gray-100 md:p-5 bg-surface dark:bg-boxdark-2 dark:border-boxdark"
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        ...
                                                        {{-- Input --}}
                                                        <input type="tel" x-model="rcLocal"
                                                            @input="
                                                    ...
                                                    {{-- Country Dropdown --}}
                                                    <div x-show="rcCountryOpen" @click.outside="rcCountryOpen = false" x-transition
                                                        x-cloak dir="rtl"
                                                        class="absolute z-[60] left-0 right-0 mt-2 top-full max-h-60 bg-white dark:bg-boxdark-2 rounded-xl border border-gray-100 dark:border-boxdark shadow-xl custom-scrollbar overflow-hidden">
                                                        <div class="p-2 border-b border-gray-50 dark:border-boxdark">
                                                    ...
                                                    <div x-show="rcOpen && rcLocal.trim().length > 0" x-transition x-cloak dir="rtl"
                                                        @click.outside="rcOpen = false"
                                                        class="absolute z-[60] left-0 right-0 mt-2 top-full max-h-48 bg-white dark:bg-boxdark rounded-xl border border-gray-100 dark:border-boxdark-2 shadow-xl overflow-y-auto custom-scrollbar p-1">
