    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <a href="{{ route('app.index') }}" class="flex gap-5 items-center p-6 rounded-3xl border shadow-sm transition-all bg-surface-container-lowest border-slate-100 active:scale-95 group">
            ...
            <div class="flex flex-col">
                <span class="text-lg font-bold font-headline text-on-surface">مكاتب داخل النظام</span>
        ...
        <a href="{{ route('offices.unverified.index') }}" class="flex gap-5 items-center p-6 rounded-3xl border shadow-sm transition-all bg-surface-container-lowest border-slate-100 active:scale-95 group">
            <div class="flex justify-center items-center w-14 h-14 rounded-2xl transition-colors bg-secondary-container/10 text-secondary group-hover:bg-secondary-container group-hover:text-white">
                <span class="text-3xl material-symbols-outlined">domain</span> 
            </div>
            <div class="flex flex-col">
                <span class="text-lg font-bold font-headline text-on-surface">مكاتب خارجية </span>
