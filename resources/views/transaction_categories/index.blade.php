...
@section('content')
    ...
    <div class="space-y-6 font-outfit" dir="rtl" x-data="{
        ...
        <div class="flex gap-6">
            ...
            <div @click="filterType = 'active'"
                :class="filterType === 'active' ? 'border-success-500 ring-2 ring-success-500/20' :
                    'border-gray-100 dark:border-gray-800'"
                class="flex-1 relative flex cursor-pointer flex-col items-start justify-between rounded-2xl bg-white p-5 dark:bg-white/[0.03] border transition-all hover:shadow-md shadow-theme-sm">
                <div
                    class="flex justify-center items-center w-10 h-10 rounded-xl bg-success-50 dark:bg-success-500/10 text-success-500">
            ...
            {{-- Inactive Categories --}}
            <div @click="filterType = 'inactive'"
                :class="filterType === 'inactive' ? 'border-gray-500 ring-2 ring-gray-500/20' :
                    'border-gray-100 dark:border-gray-800'"
                class="flex-1 relative flex cursor-pointer flex-col items-start justify-between rounded-2xl bg-white p-5 dark:bg-white/[0.03] border transition-all hover:shadow-md shadow-theme-sm">
                <div
        ...
        <div
            ...
            <div class="flex gap-3">
                ...
                @include('transaction_categories.create-category-modal')
        ...
        <div x-show="editModalOpen" x-cloak @keydown.escape.window="closeEditModal()"
            ...
            <div class="relative w-full max-w-md bg-white rounded-2xl border border-gray-100 shadow-2xl dark:bg-gray-900 dark:border-gray-800"
                ...
                <div class="flex gap-4 justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800">
                    <div class="flex gap-3 items-center">
                        <div
                            class="flex justify-center items-center w-10 h-10 rounded-xl bg-brand-50 dark:bg-brand-500/10">
                ...
                <form :action="`{{ route('transaction-categories.index') }}/${categoryToEdit.id}`" method="POST"
                    ...
                    <div>
                        ...
                        <input type="text" id="edit_category_name" name="name" x-model="categoryToEdit.name"
                    ...
                    <div class="flex gap-3 justify-end mt-6">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 text-sm font-semibold text-white rounded-xl shadow-lg transition-all bg-brand-500 hover:bg-brand-600 shadow-brand-500/30">
                            حفظ التعديلات
                        </button>
                    </div>
                </form>
