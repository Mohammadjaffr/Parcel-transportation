<header x-data="{ menuToggle: false, notifOpen: false, dropdownOpen: false }"
    ...
    <div class="flex flex-col justify-between items-center py-4 grow lg:flex-row lg:px-6">
        ...
        <div
            class="flex justify-between items-center px-3 py-3 my-2 border-b border-gray-200 lg:border-b-0 w-full lg:w-auto lg:px-0 lg:py-4 dark:border-gray-800">
                ...
                <div class="flex gap-1 items-center sm:gap-2">
                    <div class="relative">
                        ...
                        <div x-show="notifOpen" @click.outside="notifOpen = false"
                            ...
                            class="fixed top-[70px] inset-x-4 md:absolute md:top-full md:left-0 md:right-auto md:mt-3 md:w-80 bg-white/95 backdrop-blur-2xl border border-slate-100 rounded-[2rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] z-[100] flex flex-col overflow-hidden dark:bg-boxdark/95 dark:border-gray-800">
                            ...
                            <div class="flex justify-between items-center px-5 py-4 border-b border-slate-100/50 bg-slate-50/30 dark:border-gray-800 dark:bg-gray-900/30">
                                ...
                                {{-- <form action="{{ route('notifications.markAllRead') ?? '#' }}" method="POST">
                                    @csrf
                                    <button type="submit" class="text-xs font-bold transition-opacity text-primary hover:opacity-80">تحديد كمقروء</button>
                                </form> --}}
                            </div>
                ...
                <div x-cloak x-show="dropdownOpen" x-transition:enter="transition ease-out duration-100"
                    ...
                    @if (Auth::user()->type === 'admin')
                        <a href="{{ route('app.settings') }}"
                            class="flex gap-3 items-center p-3 text-sm font-bold rounded-2xl transition-colors hover:bg-slate-50 text-slate-600 hover:text-primary font-headline active:scale-95 dark:hover:bg-gray-800 dark:text-gray-300">
