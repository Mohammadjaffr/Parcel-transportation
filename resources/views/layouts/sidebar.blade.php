                  ...
                  <a href="index.html" class="menu-dropdown-item group"
                    ...
                    <li>
                        <a href="{{ route('finance.branches.index') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group"
                            :class="window.location.href.includes('{{ route('finance.branches.index') }}') ? 'menu-item-active' :
                                'menu-item-inactive'">
                    ...
                    <li>
                        <a href="{{ route('reports.revenue') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group"
                            :class="window.location.href.includes('{{ route('reports.revenue') }}') ? 'menu-item-active' :
                                'menu-item-inactive'">

                            <svg :class="window.location.href.includes('{{ route('reports.revenue') }}') ? 'menu-item-icon-active' :
                                'menu-item-icon-inactive'"
